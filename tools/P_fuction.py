...
def lielian_table(ground_truth, predictions_one, predictions_two):

    len = ground_truth.size()
    ...
    for i in range(len):
        cu_ture = ground_truth[i]
        cu_one = predictions_one[i]
        cu_two = predictions_two[i]
        if cu_one > 0.5 and cu_two > 0.5:
            yes_yes += 1
        elif cu_one > 0.5 and cu_two <= 0.5:
            yes_no += 1
        elif cu_one <= 0.5 and cu_two > 0.5:
            no_yes += 1
        elif cu_one <= 0.5 and cu_two <= 0.5:
